...
links:
  ...
  code: ''
  project: ''
image: ../../../assets/paper_cards/atrs-adaptive-trajectory-re-splitting-via-a-shared-neural-policy-for-parallel-op.svg
---

# ATRS: Adaptive Trajectory Re-splitting via a Shared Neural Policy for Parallel Optimization

![Paper card](../../../assets/paper_cards/atrs-adaptive-trajectory-re-splitting-via-a-shared-neural-policy-for-parallel-op.svg)
